...
const formSchema = z.object({
    id: z.coerce.number().int().positive().min(1, { message: "Geef een id aan"}),
    platenumber: 
        z.string()
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="outline">Voertuig Bijwerken</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        ...
        <Form {...form}>
            ...
            <DialogHeader>
              <DialogTitle>Bewerk een voertuig</DialogTitle>
